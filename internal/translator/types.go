...
// It returns the converted request payload as a byte slice and an error if the conversion fails.
...
// It returns a slice of strings, where each string is a chunk of the converted streaming response, and an error if the conversion fails.
...
// It returns the converted response as a single string and an error if the conversion fails.
